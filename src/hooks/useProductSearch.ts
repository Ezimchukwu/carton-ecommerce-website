...
const mockProducts = [
  ...
  { _id: '4', name: 'Product 4', price: 20.99, description: 'Description 4', images: [], stock: 0, sku: 'SKU004' },
  { _id: '5', name: 'Product 5', price: 8.99, description: 'Description 5', images: [], stock: 25, sku: 'SKU005' }
];
